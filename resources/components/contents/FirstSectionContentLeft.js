                    ...
                    <div className="pfy-post-grid-wrap pfy-overlay-style-9">
                        <div className="pfy-post-item pfy-scale">
                            <div className="pfy-post-thumb pfy-img-commn-style">
                                <a title="Fasion Trends and Li Edelkoort the Culture Shock Special Report" href="#"><img loading="lazy" width="1500" height="1000" src="https://interpretasi.id/assets/images/articles/default.png" className="attachment-full size-full wp-post-image" alt="" decoding="async" srcSet="https://interpretasi.id/assets/images/articles/default.png 1500w, https://interpretasi.id/assets/images/articles/default.png 300w, https://interpretasi.id/assets/images/articles/default.png 1024w, https://interpretasi.id/assets/images/articles/default.png 768w" sizes="(max-width: 1500px) 100vw, 1500px" /></a>
                            </div>
                            <div className="pfy-post-content">
                                ...
                                <h1 className="pfy-post-title">
                                    <a href="#">Fasion Trends and Li Edelkoort the Culture Shock Special Report</a>
                                </h1>
                                <ul className="pfy-post-gd-meta">
                                    <li>BY <a href="#" title="Posts by David" rel="author">David</a></li>
                                    <li><i className="fal fa-calendar-alt"></i> Jul 07, 2022</li>
                                    <li><i className="far fa-comments"></i> 1 Comment </li>
                                    <li><i className="far fa-eye"></i> 839 Views</li>
                                </ul>
                            </div>
                        </div>
                    </div>
