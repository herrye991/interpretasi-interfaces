                            ...
                            <div className="col-lg-6 col-md-6 col-xl-6" key={idx}>
                                <div className="pfy-post-item pfy-scale pfy-ch">
                                    ...
                                    <div className="pfy-post-content">
                                        ...
                                        <ul>
                                            <li><span className="auth_by">Oleh &nbsp;</span><a href={ ENV.userURL(row.user.id + '/' + Text.specialRemove(row.user.name)) } title={"Diposting oleh " + row.user.name} rel="author"> {row.user.name }</a></li>
